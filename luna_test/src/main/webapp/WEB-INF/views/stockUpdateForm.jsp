				...
				<input type="hidden" name="pnum" value="${dto.pnum}">
					<table align="center" border="0" cellpadding="5" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse" >
						...
						<tr>
							<th>상품번호</th>
							<td>
								<input type="number" name="pnum" value="${dto.pnum }" readonly="readonly">
							</td>
						</tr>
						<tr>
							<th>상품명</th>
...
<!-- 						<p>상품명 -->
<%-- 							<input type="text" name="pname" value="${dto.pname }"></p> --%>
<!-- 						<p>상품재고수량 -->
<%-- 							<input type="number" name="scount" value="${dto.scount }"></p> --%>
<!-- 						<p>원가 -->
<%-- 							<input type="number" name="cost" value="${dto.cost }" ></p> --%>
<!-- 						<p>내용 -->
